...
VALUES (1, 'pitch:view'),
       (2, 'pitch:create'),
       (3, 'pitch:booking'),
       (4, 'pitch:booking-history'),
       (5, 'pitch:update'),
       (6, 'pitch:booking-approval'),
       (7, 'pitch:create-approval'),
       (8, 'team:view'),
       (9, 'team:view-detail'),
       (10, 'team:create'),
       (11, 'team:register'),
       (12, 'team:update'),
       (13, 'team:create-recruit'),
       (14, 'team:approval'),
       (15, 'team:delete-member'),
       (16, 'invitation:view'),
       (17, 'invitation:create'),
       (18, 'invitation:register'),
       (19, 'invitation:approval'),
       (20, 'user:view');
...
VALUES ('001', 'Quận Ba Đình', '01'),
       ...
       ('024', 'Thành phố Hà Giang', '07'),
       ('026', 'Huyện Đồng Văn', '07'),
       ('027', 'Huyện Mèo Vạc', '07'),
       ('028', 'Huyện Yên Minh', '07'),
       ('029', 'Huyện Quản Bạ', '07'),
       ('030', 'Huyện Vị Xuyên', '07'),
       ('031', 'Huyện Bắc Mê', '07'),
       ('032', 'Huyện Hoàng Su Phì', '07'),
       ('033', 'Huyện Xín Mần', '07'),
       ('034', 'Huyện Bắc Quang', '07'),
       ('035', 'Huyện Quang Bình', '07'),
       ('040', 'Thành phố Cao Bằng', '09'),
       ('042', 'Huyện Bảo Lâm', '09'),
       ('043', 'Huyện Bảo Lạc', '09'),
       ('045', 'Huyện Hà Quảng', '09'),
       ('047', 'Huyện Trùng Khánh', '09'),
       ('048', 'Huyện Hạ Lang', '09'),
       ('049', 'Huyện Quảng Hòa', '09'),
       ('051', 'Huyện Hoà An', '09'),
       ('052', 'Huyện Nguyên Bình', '09'),
       ('053', 'Huyện Thạch An', '09'),
       ...
       ('303', 'Quận Hồng Bàng', '04'),
       ('304', 'Quận Ngô Quyền', '04'),
       ('305', 'Quận Lê Chân', '04'),
       ('306', 'Quận Hải An', '04'),
       ('307', 'Quận Kiến An', '04'),
       ('308', 'Quận Đồ Sơn', '04'),
       ('309', 'Quận Dương Kinh', '04'),
       ('311', 'Huyện Thuỷ Nguyên', '04'),
       ('312', 'Huyện An Dương', '04'),
       ('313', 'Huyện An Lão', '04'),
       ('314', 'Huyện Kiến Thuỵ', '04'),
       ('315', 'Huyện Tiên Lãng', '04'),
       ('316', 'Huyện Vĩnh Bảo', '04'),
       ('317', 'Huyện Cát Hải', '04'),
       ('318', 'Huyện Bạch Long Vĩ', '04'),
       ...
       ('490', 'Quận Liên Chiểu', '03'),
       ('491', 'Quận Thanh Khê', '03'),
       ('492', 'Quận Hải Châu', '03'),
       ('493', 'Quận Sơn Trà', '03'),
       ('494', 'Quận Ngũ Hành Sơn', '03'),
       ('495', 'Quận Cẩm Lệ', '03'),
       ('497', 'Huyện Hòa Vang', '03'),
       ('498', 'Huyện Hoàng Sa', '03'),
       ...
       ('718', 'Thành phố Thủ Dầu Một', '05'),
       ('719', 'Huyện Bàu Bàng', '05'),
       ('720', 'Huyện Dầu Tiếng', '05'),
       ('721', 'Thị xã Bến Cát', '05'),
       ('722', 'Huyện Phú Giáo', '05'),
       ('723', 'Thị xã Tân Uyên', '05'),
       ('724', 'Thành phố Dĩ An', '05'),
       ('725', 'Thành phố Thuận An', '05'),
       ('726', 'Huyện Bắc Tân Uyên', '05'),
       ...
       ('761', 'Quận 12', '02'),
       ('764', 'Quận Gò Vấp', '02'),
       ('765', 'Quận Bình Thạnh', '02'),
       ('766', 'Quận Tân Bình', '02'),
       ('767', 'Quận Tân Phú', '02'),
       ('768', 'Quận Phú Nhuận', '02'),
       ('769', 'Thành phố Thủ Đức', '02'),
       ('770', 'Quận 3', '02'),
       ('771', 'Quận 10', '02'),
       ('772', 'Quận 11', '02'),
       ('773', 'Quận 4', '02'),
       ...
       ('775', 'Quận 6', '02'),
       ('776', 'Quận 8', '02'),
       ('777', 'Quận Bình Tân', '02'),
       ('778', 'Quận 7', '02'),
       ('783', 'Huyện Củ Chi', '02'),
       ('784', 'Huyện Hóc Môn', '02'),
       ('785', 'Huyện Bình Chánh', '02'),
       ('786', 'Huyện Nhà Bè', '02'),
       ('787', 'Huyện Cần Giờ', '02'),
